// Einen ganzen Datenbestand aus den **eingefrorenen** Tabellen zurücklesen (Aufgabe 6b).
//
// Gebraucht wird das an genau einer Stelle: bei der centgenauen Regression des Umstiegs
// (`db/changeover.ts`). Dort steht in der Datei zu diesem Zeitpunkt **nur** Migration 0000, und
// gelesen werden muss sie deshalb mit dem Schema von damals.
//
// **Ohne diese Datei bricht der Umstieg bei der ersten Migration, die eine Spalte hinzufügt.**
...
// nicht mehr, versteht es ihn auf beiden Seiten nicht, und die Differenz bleibt null. Ein Verlust
...
} from './schema.ts'  // eingefroren, siehe README.md
